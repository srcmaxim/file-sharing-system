...
insert into file_sharing_system.user (login, password, firstName, lastName, email, phone) values ("user1", "12345qaz", "User1firstname", "User1lastname", "user1@gmail.com", "+1(111)-111-1111");
insert into file_sharing_system.user (login, password, firstName, lastName, email, phone) values ("user2", "12345qaz", "User2firstname", "User2lastname", "user2@gmail.com", "+2(222)-222-2222");
insert into file_sharing_system.user (login, password, firstName, lastName, email, phone) values ("user3", "12345qaz", "User3firstname", "User3lastname", "user3@gmail.com", "+3(333)-333-3333");
